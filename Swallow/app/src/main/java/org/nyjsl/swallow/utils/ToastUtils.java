...
import org.nyjsl.swallow.http.okhttp.HttpException;
...
public class ToastUtils {
    ...
    public static void show(final Activity activity,final int resId,final int viewId){
        if(activity == null)
            return;
        Toaster.showCustomLong(activity,resId,viewId);
    }
    ...
    public static void show(final Activity activity, final Exception e,
        ...
        if (e instanceof HttpException)
            message = ((HttpException) e).toString();
        else
            message = null;
